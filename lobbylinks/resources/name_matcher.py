...
try:
    ...
    from jellyfish import jaro_similarity as jaro_winkler

def jaro_distfun(str1, str2):
...
class NameMatcher:
	...
	def __init__(self, distfun='levenshtein'):
		self.__name__ = f'NameMatcher(distfun={distfun})'
		if distfun == 'levenshtein':
			self.distfun = self._levenshtein_log
		elif distfun == 'jaro_winkler':
			self.distfun = jaro_distfun #lambda str1,str2: 1 - jaro_winkler(str1, str2)
